...
const SettingNavigation = () => {
    return (
        <div className='setting-nav-container'>
            <div className="setting-option" onClick={() => setGlobalState('uploadAvatarModal', 'open-modal')}>
                <div className="option-icon-container">
                    <svg fill="#999da3" height="24px" width="24px" version="1.1" id="Capa_1" viewBox="0 0 487 487" >
                        <g>
                            <g>
